...
const ContactUs = () => {
  ...
  return (
    <div className="max-w-7xl mt-20 mx-auto p-8 bg-gradient-to-br from-orange-100 via-teal-50 to-green-50 rounded-lg shadow-xl">
        ...
        <div className="bg-white rounded-lg p-8 contact-info opacity-0 transition-opacity duration-1000">
          ...
          <div className="space-y-6">
            <div className="flex items-center">
              ...
              <span className="text-lg font-medium text-gray-800">kg369033@gmail.com</span>
            </div>
            <div className="flex items-center">
              <FontAwesomeIcon icon={faPhone} className="text-orange-500 w-6 h-6 mr-3" />
              <span className="text-lg font-medium text-gray-800">+91 9289597998</span>
            </div>
            <div className="flex items-center">
