  ...
  const navigate = useNavigate();
    return (
      <div className="px-3 container mx-auto py-8">
        ...
        <h1 className="text-3xl font-bold m-0 mb-4 underline underline-offset-8">Privacy Policy</h1>
        <p className="text-gray-700 mb-2">Last updated: March 14, 2025</p>
        ...
        <p className="text-gray-700 mb-4">For the purposes of this Privacy Policy:
        <ul className="list-none">
          ...
          <li>
            <p className="text-gray-700">
              <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Company, NSUT sector 3 Dwarka.
            </p>
          </li>
          <li>
            <p className="text-gray-700">
          ...
          <li>
            <p className="text-gray-700">
              <strong>Website</strong> refers to EasyEat, accessible from{' '}
              <a
                href="http://www.canteenmanagement.com"
                rel="noopener noreferrer"
                target="_blank"
                className="text-blue-500 hover:underline"
              >
                http://www.canteenmanagement.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul className="list-none">
          <li>
            ...
            <p className="text-gray-700 ml-6">Type: Session Cookies</p>
            <p className="text-gray-700 ml-6">Administered by: Us</p>
          ...
          <li>
            ...
            <p className="text-gray-700 ml-6">Type: Persistent Cookies</p>
            <p className="text-gray-700 ml-6">Administered by: Us</p>
            <p className="text-gray-700 ml-6">Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
          </li>
          <li>
            <p className="text-gray-700">
        ...
        <p className="text-gray-700 mb-4">retain this data for longer time periods.</p>
        ...
        <h3 className="text-lg font-semibold mb-2">Delete Your Personal Data</h3>
        <p className="text-gray-700 mb-4">You have the right to delete or request that We assist in deleting the Personal Data that We have collected about You.</p>
        <p className="text-gray-700 mb-4">Our Service may give You the ability to delete certain information about You from within the Service.</p>
        <p className="text-gray-700 mb-4">
          You may update, amend, or delete Your information at any time by signing in to Your Account, if you have one, and visiting the account settings section that allows you to manage Your personal information. You may also contact Us to request access to, correct, or delete any personal information that You have provided to Us.
        </p>
        <p className="text-gray-700 mb-4">Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis to do so.</p>
        ...
        <p className="text-gray-700 mb-4">If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
  
        <h4 className="text-md font-semibold mb-2">Law enforcement</h4>
        <p className="text-gray-700 mb-4">Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
        ...
        <ul className="list-none ">
          <li>
            <p className="text-gray-700">Comply with a legal obligation</p>
          </li>
          <li>
            <p className="text-gray-700">Protect and defend the rights or property of the Company</p>
          </li>
          <li>
            <p className="text-gray-700">Prevent or investigate possible wrongdoing in connection with the Service</p>
          </li>
          <li>
            <p className="text-gray-700">Protect the personal safety of Users of the Service or the public</p>
          </li>
          <li>
            <p className="text-gray-700">Protect against legal liability</p>
          </li>
        </ul>
        ...
        <p className="text-gray-700 mb-4">If We need to rely on consent as a legal basis for processing Your information and Your country requires consent from a parent, We may require Your parent's consent before We collect and use that information.</p>
  
        <h2 className="text-xl font-semibold mb-4">Links to Other Websites</h2>
        <p className="text-gray-700 mb-4">Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
        <p className="text-gray-700 mb-4">We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
        ...
        <p className="text-gray-700 mb-4">We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the &quot;Last updated&quot; date at the top of this Privacy Policy.</p>
        <p className="text-gray-700 mb-4">You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>
  
        <h2 className="text-xl font-semibold mb-4">Contact Us</h2>
        <p className="text-gray-700 mb-4">If you have any questions about this Privacy Policy, You can contact us:</p>
        <ul className="list-none">
          <li>
            <p className="text-gray-700">By email: office@mycompany.com</p>
          </li>
          <li>
            <p className="text-gray-700">
              By visiting this page on our website:{' '}
              <a href="http://www.mycompany.com/contact" rel="noopener noreferrer" target="_blank" className="text-blue-500 hover:underline">
